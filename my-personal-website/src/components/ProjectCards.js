...
const projects = [
    ...
    {name: "Bot Denis", description: "Un bot discord permetant de lancer un vote afin de parier sur les épreuves de Koh Lanta", link: "https://github.com/FlorentinMarechal/discord-bot-kl"},
